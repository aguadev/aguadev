...
"x86_64-linux-3.8.0-35-generic" or
	die "Errno architecture (x86_64-linux-3.8.0-35-generic) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
