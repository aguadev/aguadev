 ...
 */
{
    ...
    regularize_conf: function( o, load_args ) {
        ...
        console.log("JB_json_v0.regularize_conf    o: ");
        console.dir({o:o});
        console.log("JB_json_v0.regularize_conf    load_args: ");
        ...
        dojo.forEach( o.tracks, function( trackdef ) {
            ...
            console.log("JB_json_v0.regularize_conf    trackdef: ");
            console.dir({trackdef:trackdef});
