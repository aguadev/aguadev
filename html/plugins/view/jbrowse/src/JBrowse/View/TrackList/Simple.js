...
return declare( 'JBrowse.View.TrackList.Simple', null,
    ...
    constructor: function( args ) {
        console.log("View.TrackList.Simple.constructor    args:");
        ...
        this.createTrackList( args.browser.leftPane.containerNode );
    ...
    addTracks: function( trackConfigs ) {
        console.log("View.TrackList.Simple.addTracks    trackConfigs:");
    ...
    createTrackList: function( renderTo ) {
        console.log("View.TrackList.Simple.createTrackList    renderTo: " + renderTo);
        ...
        var leftPane = dojo.create(
            'div',
            {
                // CHANGED
                //id: 'trackPane',
                id: this.browser.centerPane.containerNode.id + "_trackPane",
        ...
        var trackListDiv = this.div = dojo.create(
            'div',
            {
                // CHANGED
                //id: 'tracksAvail',
                id: this.browser.centerPane.containerNode.id + "_tracksAvail",
                ...
                //innerHTML: '<div class="availableTracks">Available Tracks<div>'
            },
            leftPane
        );
