console.log("JBrowse/GenomeView    LOADING");
...
var GenomeView = function( browser, elem, stripeWidth, refseq, zoomLevel ) {
    ...
    console.log("GenomeView.init    elem: " + elem);
    console.dir({elem:elem});
    console.log("GenomeView.init    this: " + this);
    console.dir({this:this});
    console.log("GenomeView.init    this.id: " + this.id);
    ...
    console.log("GenomeView.init    this.posHeight: " + this.posHeight);
    console.log("GenomeView.init    this.topSpace: " + this.topSpace);
    ...
    console.log("GenomeView.init    this.stripeWidth: " + this.stripeWidth);
    ...
    console.log("GenomeView.init    DOING this._renderVerticalScrollBar()");
    this._renderVerticalScrollBar();
    console.log("GenomeView.init    AFTER this._renderVerticalScrollBar()");
    ...
    this.zoomContainer.id = this.elem.id + "_zoomContainer";
    ...
    scaleTrackDiv.id = this.elem.id + "_static_track";
    ...
    gridTrackDiv.id = this.elem.id + "_gridtrack";
    ...
    console.log("GenomeView.init    END");
};
...
GenomeView.prototype.addOverviewTrack = function(track) {
    ...
    trackDiv.id = this.elem.id + "_overviewtrack_" + track.name;
...
GenomeView.prototype.showTracks = function( trackConfigs ) {
    ...
    console.log("GenomeView.showTracks    trackConfigs: ");
    console.dir({trackConfigs:trackConfigs});
    ...
    console.log("GenomeView.showTracks    needed: ");
    ...
    console.log("GenomeView.showTracks    DOING this.updateTrackList()");
    this.updateTrackList();

    console.log("GenomeView.showTracks    END");
};
...
GenomeView.prototype.updateTrackList = function() {
    ...
    console.log("GenomeView.updateTracklist    this.tracksIndices: " + this.trackIndices);
    console.dir({this_trackIndices:this.trackIndices});
    ...
    console.log("GenomeView.updateTracklist    this.tracks: " + this.tracks);
    ...
    console.log("GenomeView.updateTracklist    END");

    this.browser.parentWidget.updateTracks(this.browser, this.tracks);
};
...
console.log("JBrowse/GenomeView    COMPLETED");