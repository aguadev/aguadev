console.log("JBrowse.Store.NCList    LOADING")
console.log("JBrowse.Store.NCList    this: " + this)
...
NCList.prototype.importExisting = function(nclist, attrs, baseURL,
	...
	console.log("JBrowse.Store.NCList.importExisting    attrs: ");
...
NCList.prototype.fill = function(intervals, attrs) {
	...
	console.log("JBrowse.Store.NCList.fill    attrs:")
	console.dir({attrs:attrs});
...
NCList.prototype.histogram = function(from, to, numBins, callback) {
	console.log("JBrowse.Store.NCList.histogram")
