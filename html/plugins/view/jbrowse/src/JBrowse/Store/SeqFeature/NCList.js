...
return declare( SeqFeatureStore,
{
    ...
    loadNCList: function( refData, trackInfo, url ) {
        ...
        console.log("JBrowse.Store.SeqFeature.loadNCList    refData: " + refData);
        console.dir({refData:refData});
    ...
    getDataRoot: function( refName ) {
        ...
        //console.log("Store.SeqFeature.NCList.getDataRoot    refName: " + refName);
        //console.log("Store.SeqFeature.NCList.getDataRoot    this._deferred.root: " + this._deferred.root);
        //console.log("Store.SeqFeature.NCList.getDataRoot    this.curRefName: " + this.curRefName);
        
        if( ! this._deferred.root || this.curRefName != refName ) {

        //console.log("Store.SeqFeature.NCList.getDataRoot    INSIDE if( ! this._deferred.root || this.curRefName != refName )");
            ...
            //console.log("Store.SeqFeature.NCList.getDataRoot    refData: " + refData);
            ...
            //console.log("Store.SeqFeature.NCList.getDataRoot    url: " + url);
            ...
            xhr.get( url, { handleAs: 'json', failOk: true })
               .then( function( trackInfo, request ) {
                        ...
                        //console.log("Store.SeqFeature.NCList.getDataRoot    trackInfo: ");
    ...
    _handleTrackInfo: function( refData, trackInfo, url ) {
        ...
        //console.log("Store.SeqFeature.NCList._handleTrackInfo    caller: " + this._handleTrackInfo.caller.nom);
        //
        //console.log("Store.SeqFeature.NCList._handleTrackInfo    refData: ");
        //console.dir({refData:refData});
        //console.log("Store.SeqFeature.NCList._handleTrackInfo    trackInfo: ");
        //console.dir({trackInfo:trackInfo});
        //console.log("Store.SeqFeature.NCList._handleTrackInfo    url: ");
        //console.dir({url:url});
        ...
        if( trackInfo.intervals ) {
            ...
            //console.log("Store.SeqFeature.NCList._handleTrackInfo    trackInfo.intervals.classes: " + trackInfo.intervals.classes);
            //
            //console.log("Store.SeqFeature.NCList._handleTrackInfo    DOING refData.attrs = new ArrayRepr( trackInfo.intervals.classes)");
    ...
    _getFeatures: function( data, query,  origFeatCallback, finishCallback, errorCallback ) {
        ...
        console.log("Store.SeqFeature.NCList._getFeatures    data: ");
