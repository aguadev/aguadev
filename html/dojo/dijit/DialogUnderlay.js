define([
	...
	var DialogUnderlay = declare("dijit.DialogUnderlay", [_Widget, _TemplatedMixin], {
		...
		layout: function(){
			...
			//console.log("----------------------- dijit.DialogUnderlay.layout    viewport: " + viewport);
		...
		show: function(){
			//console.log("----------------------- dijit.DialogUnderlay.show");
			// summary:
		...
		hide: function(){
			//console.log("----------------------- dijit.DialogUnderlay.hide");
			// summary:
	...
	DialogUnderlay.show = function(/*Object*/ attrs, /*Number*/ zIndex){
		...
		//console.log("----------------------- dijit.DialogUnderlay.show    EXTERNAL    attrs: " + attrs);
		//console.log("----------------------- dijit.DialogUnderlay.show    EXTERNAL    zIndex: " + zIndex);
	...
	DialogUnderlay.hide = function(){
		...
		//console.log("----------------------- dijit.DialogUnderlay.hide    EXTERNAL");
