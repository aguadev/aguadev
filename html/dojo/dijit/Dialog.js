define([
	...
	var _DialogBase = declare("dijit._DialogBase" + (has("dojo-bidi") ? "_NoBidi" : ""), [_TemplatedMixin, _FormMixin, _DialogMixin, _CssStateMixin], {
		...
		show: function(){
			...
			//console.log("dijit.Dialog.show    HERE 1");
			...
			//console.log("dijit.Dialog.show    HERE 2");
			...
			//console.log("dijit.Dialog.show    HERE 3");
			...
			//console.log("dijit.Dialog.show    HERE 4");
				}),
				onEnd: lang.hitch(this, function(){
					...
					delete this._fadeInDeferred;
			//console.log("dijit.Dialog.show    HERE 5");


				})
			}).play();

		//console.log("dijit.Dialog.show    HERE 6");
