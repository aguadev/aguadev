	...
	return dojo.declare('dojox.widget.Dialog', dojox.widget.DialogSimple,
		...
		_setup: function(){
			...
			if(!this._alreadyInitialized){
				...
				//console.log("dojox.widget.Dialog._setup    this.showTitle: " + this.showTitle)
			
			
				if(!this.showTitle){
					
					//console.log("dojox.widget.Dialog._setup    DOING dojo.addClass(this.domNode,'dojoxDialogNoTitle')")
		...
		_setSize: function(){
			...
			//console.log("----------------------- dojox.widget.Dialog._setSize    caller: " + this._setSize.caller.nom);
		...
		show: function(){
			...
			//console.log("----------------------- dojox.widget.Dialog._show    this.open: " + this.open);

			if ( dijit._underlay ) {
				var style = dojo.style(dijit._underlay.domNode);
				//console.log("----------------------- dojox.widget.Dialog._show    style: " + style);
			...
			//console.log("----------------------- dojox.widget.Dialog._show    this.modal: " + this.modal);
			if(this.modal){
			...
			//console.log("----------------------- dojox.widget.Dialog._show    dojo.keys.ESCAPE: " + dojo.keys.ESCAPE);

				this._modalconnects.push(dojo.connect(dojo.body(), "onkeypress", function(e){
					//console.log("----------------------- dojox.widget.Dialog._show    e.charOrCode: " + e.charOrCode);
		...
		_position: function(){
			...
			console.log("----------------------- dojox.widget.Dialog._position");
			return;
			...
			console.log("----------------------- dojox.widget.Dialog._position    props.width: " + props.width);
			console.log("----------------------- dojox.widget.Dialog._position    props.height: " + props.height);

			this._sizing = dojox.fx.sizeTo(props);
			this._sizingConnect = this.connect(this._sizing,"onEnd","_showContent");
			this._sizing.play();

			console.log("----------------------- dojox.widget.Dialog._position    AFTER this._sizing.play()");
		...
		_showContent: function(e){
			...
			//console.log("----------------------- dojox.widget.Dialog._showContent    this._displaysize.h: " + this._displaysize.h);
			//console.log("----------------------- dojox.widget.Dialog._showContent    this._displaysize.w: " + this._displaysize.w);
