...
return declare(null, {
	...
	renderArray: function(){
		...
		//console.log("dojo.dgrid.Selection.renderArray    grid: ");
		//console.dir({grid:grid});
		//console.log("dojo.dgrid.Selection.renderArray    rows: ");
		//console.dir({rows:rows});
		
		Deferred.when(rows, function(rows){

			//console.log("dojo.dgrid.Selection.renderArray    INSIDE Deferred.when(rows), rows: ");
			//console.dir({rows:rows});
			...
			for(i = 0; i < rows.length; i++){
				...
				// DEBUG
				if ( ! row ) {
					//console.log("dojo.dgrid.Selection.renderArray    row not defined at i: " + i);
				}
