...
Manager.prototype.handleUpgrade = function (req, socket, head) {
  ...
  //console.log("socketio.lib.manager.handleUpgrade    req: " + req);
  //console.dir({req:req});
  //console.log("socketio.lib.manager.handleUpgrade    socket: " + socket);
  //console.dir({socket:socket});
  //console.log("socketio.lib.manager.handleUpgrade    head: " + head);
  //console.dir({head:head});
  //console.log("socketio.lib.manager.handleUpgrade    this.data: " + this.data);
