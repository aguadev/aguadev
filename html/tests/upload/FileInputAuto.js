...
dojo.declare("dojox.widget.FileInputAuto",
	...
	startup: function(){
	    console.log("startup	plugins.project.FileInputAuto.startup()");
	...
	_onFocus: function(){
	    console.log("_onFocus	plugins.project.FileInputAuto._onFocus()");
		// summary: clear the upload timer
		if(this._blurTimer){ clearTimeout(this._blurTimer); }
	},

	_onBlur: function(){
	    console.log("_onBlur	plugins.project.FileInputAuto._onBlur()");
	...
	setMessage: function(/*String*/title){
	    console.log("setMessage	plugins.project.FileInputAuto.setMessage(/*String*/title)");
	...
	_sendFile: function(/* Event */e){
	    console.log("_sendFile	plugins.project.FileInputAuto._sendFile(/* Event */e)");
	...
	_handleSend: function(data,ioArgs){
	    console.log("_handleSend	plugins.project.FileInputAuto._handleSend(data,ioArgs)");
	...
	_onClick: function(e){
	    console.log("_onClick	plugins.project.FileInputAuto._onClick(e)");
	...
	onComplete: function(data,ioArgs,widgetRef){
	    console.log("onComplete	plugins.project.FileInputAuto.onComplete(data,ioArgs,widgetRef)");
