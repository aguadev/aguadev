...
dojo.declare("dojox.widget.FileInput",
	...
	startup: function(){
	    console.log("startup	plugins.project.FileInput.startup()");
	...
	_matchValue: function(){
	    console.log("_matchValue	plugins.project.FileInput._matchValue()");
	...
	setLabel: function(/* String */label,/* String? */cssClass){
	    console.log("setLabel	plugins.project.FileInput.setLabel(/* String */label,/* String? */cssClass)");
		// summary: method to allow use to change button label
		this.titleNode.innerHTML = label;
	},

	_onClick: function(/* Event */e){
	    console.log("_onClick	plugins.project.FileInput._onClick(/* Event */e)");
