...
class Test::Agua::Uml::Role with (Test::Agua::Common::Util) extends Agua::Uml::Role {
...
method testSetRoles {
	diag("Role.t    DOING testSetRoles()\n");

	my $targetfile	=	"$Bin/inputs/lib/Agua/Common/Cluster.pm";
...
method testSetRoleName {
	...
	my $modulename = $self->setRoleName($contents);
