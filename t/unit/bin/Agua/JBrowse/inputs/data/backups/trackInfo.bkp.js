dojo.provide("plugins.view.jbrowse.species.human.hg19.data.trackInfo");
trackInfo = 
[
   {
   ...
   {
      "url" : "data/tracks/{refseq}/omimGene/trackData.json",
      "type" : "FeatureTrack",
      "label" : "omimGene",
      "key" : "OMIM Genes"
   },
   ...
   {
      "url" : "data/tracks/{refseq}/cytoBandIdeo/trackData.json",
      "label" : "cytoBandIdeo",
      "type" : "FeatureTrack",
   ...
   {
      "url" : "data/tracks/{refseq}/gold/trackData.json",
      "type" : "FeatureTrack",
      "label" : "gold",
      "key" : "Assembly"
   },
   {
      "url" : "data/tracks/{refseq}/gap/trackData.json",
      "type" : "FeatureTrack",
      "label" : "gap",
      "key" : "Gap"
   },
   {
      "url" : "data/tracks/{refseq}/knownAlt/trackData.json",
      "label" : "knownAlt",
      "type" : "FeatureTrack",
      "key" : "Alt Events"
   },
   {
      "url" : "data/tracks/{refseq}/gwasCatalog/trackData.json",
      "type" : "FeatureTrack",
      "label" : "gwasCatalog",
      "key" : "GWAS Catalog"
   },
   {
      "url" : "data/tracks/{refseq}/tRNAs/trackData.json",
      "label" : "tRNAs",
      "type" : "FeatureTrack",
      "key" : "tRNA Genes"
   },
   ...
   {
      "url" : "data/tracks/{refseq}/cpgIslandExt/trackData.json",
      "type" : "FeatureTrack",
      "label" : "cpgIslandExt",
      "key" : "CpG Islands"
   },
   ...
   {
      "url" : "data/tracks/{refseq}/genomicSuperDups/trackData.json",
      "type" : "FeatureTrack",
      "label" : "genomicSuperDups",
      "key" : "Segmental Dups"
   },
   {
