...
PURPOSE
	...
	Test Agua::Common::Request module
...
BEGIN {
    use_ok('Conf::Yaml');
    use_ok('Test::Agua::Common::Request');
}
require_ok('Conf::Yaml');
require_ok('Test::Agua::Common::Request');
...
my $object = new Test::Agua::Common::Request(
    conf        =>  $conf,
    logfile     =>  $logfile,
	SHOWLOG     =>  $SHOWLOG,
	PRINTLOG    =>  $PRINTLOG
);
isa_ok($object, "Test::Agua::Common::Request", "object");
